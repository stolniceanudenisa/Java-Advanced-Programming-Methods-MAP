...
public class UtilizatorController implements Observer<UtilizatorEntityChangeEvent> {
    ...
    public void initialize() {
        tableColumnFirstName.setCellValueFactory(new PropertyValueFactory<Utilizator, String>("first_name"));
        tableColumnLastName.setCellValueFactory(new PropertyValueFactory<Utilizator, String>("last_name"));
